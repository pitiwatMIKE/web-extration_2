...
with open(path+'word_to_ix.pkl', 'rb') as file:
    word_to_ix = dill.load(file)
with open(path+'pos_to_ix.pkl', 'rb') as file:
...
model.load_state_dict(torch.load(path+"model_BiLSTM-CRF.model"), strict=False)
